...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Social proof */}
      <section className="px-6 py-10 bg-gray-50 border-y border-gray-100">
        <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-8 text-center">
          {[
            ...
            <div key={label} className="flex items-center gap-3 px-6 first:border-r border-gray-200 last:border-l border-gray-200">
      ...
      {/* Footer */}
      <footer className="border-t border-gray-100 bg-gray-50/60 px-6 py-10">
        <div className="max-w-6xl mx-auto">
