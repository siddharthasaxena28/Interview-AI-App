            ...
            <div className="mt-5 space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full text-sm border border-gray-200 rounded-xl px-4 py-3 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                />
              </div>
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <button
                  ...
                  disabled={submitting}
                  className="bg-blue-600 text-white text-sm font-semibold px-6 py-2.5 rounded-xl hover:bg-blue-700 disabled:opacity-60 transition-colors"
                >
