...
export default function EnableReminders() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1.5 text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 px-3 py-1.5 rounded-lg transition-colors disabled:opacity-60"
    >
      {status === 'working' ? (
        <>
