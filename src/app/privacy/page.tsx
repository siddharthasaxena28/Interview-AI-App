              ...
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-gray-100">
                  {[
                    ...
                    ['Payment identifiers (Razorpay order / subscription IDs)', 'Razorpay payment gateway', 'Verify payments and prevent duplicate credits. We do not store card numbers or bank details — these remain with Razorpay.'],
